...
const CommonScreen = () => {
    ...
    const choices = [
        {
            title: 'מה זו האפליקציה הזו?',
            information: 'זוהי אפליקציה אשר פותחה במסגרת עזרה לקהילה ופרוייקט גמר של מהנדסות לעולם טוב יותר, יצרנו אותה כדי ליצור קשר בין נשים שיצאו ממעגל האלימות לסיוע והעלאת המודעות בנושא.'
        },
        {
            title: 'מה מטרת האפליקציה?',
            information: 'להוות רשת חברתית בטוחה ומוגנת המשמשת כמרחב בו נשים יוכלו לקבל סיוע של גורמים מסויימים.' 
        },
        {
            title: 'איך ניתן ליצור עמכן קשר?',
            information: 'בדף הבית תמצאו כפתור צור קשר עם אפשרות לשלוח לנו הודעה עם פרטים נוספים לפנייה.'
        },
        {
